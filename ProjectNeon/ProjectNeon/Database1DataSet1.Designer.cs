...
namespace ProjectNeon {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomerRow AddCustomerRow(string CompanyName, string AddressLine1, string AddressLine2, string City, string State, string Zip, decimal Balance) {
...
namespace ProjectNeon.Database1DataSet1TableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customer] SET [CompanyName] = @CompanyName, [AddressLine1] = @AddressLine1, [AddressLine2] = @AddressLine2, [City] = @City, [State] = @State, [Zip] = @Zip, [Balance] = @Balance WHERE (([CustomerID] = @Original_CustomerID) AND ([CompanyName] = @Original_CompanyName) AND ([AddressLine1] = @Original_AddressLine1) AND ((@IsNull_AddressLine2 = 1 AND [AddressLine2] IS NULL) OR ([AddressLine2] = @Original_AddressLine2)) AND ([City] = @Original_City) AND ([State] = @Original_State) AND ([Zip] = @Original_Zip) AND ((@IsNull_Balance = 1 AND [Balance] IS NULL) OR ([Balance] = @Original_Balance)));
SELECT CustomerID, CompanyName, AddressLine1, AddressLine2, City, State, Zip, Balance FROM Customer WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, CompanyName, AddressLine1, AddressLine2, City, State, Zip, Bal" +
                "ance FROM dbo.Customer";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT CustomerID, CompanyName, AddressLine1, AddressLine2, City, State, Zip, Bal" +
                "ance FROM dbo.Customer";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT CustomerID, CompanyName, AddressLine1, AddressLine2, City, State, Zip, Bal" +
                "ance FROM dbo.Customer WHERE JobType = \'Company\'";
        ...
        public virtual int FillBy(Database1DataSet1.CustomerDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy1(Database1DataSet1.CustomerDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CustomerID, string Original_CompanyName, string Original_AddressLine1, string Original_AddressLine2, string Original_City, string Original_State, string Original_Zip, global::System.Nullable<decimal> Original_Balance) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CompanyName, string AddressLine1, string AddressLine2, string City, string State, string Zip, global::System.Nullable<decimal> Balance, int Original_CustomerID, string Original_CompanyName, string Original_AddressLine1, string Original_AddressLine2, string Original_City, string Original_State, string Original_Zip, global::System.Nullable<decimal> Original_Balance) {
            return this.Update(CompanyName, AddressLine1, AddressLine2, City, State, Zip, Balance, Original_CustomerID, Original_CompanyName, Original_AddressLine1, Original_AddressLine2, Original_City, Original_State, Original_Zip, Original_Balance, Original_CustomerID);
        }
    }
